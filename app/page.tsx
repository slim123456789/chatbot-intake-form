...
export default function EnhancedChat() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
        // block: 'start' with a negative offset or 'center' works best for tall lists
  ...
  const submitAnswer = (value: any) => {
    ...
    // Stop if legal consent is denied
  ...
  return (
    <div className="flex flex-col h-screen bg-[#FDFDFF] font-sans antialiased">
      ...
      <footer ref={dockRef} className="bg-white border-t p-6 md:p-10 z-40">
        <div className="max-w-xl mx-auto">
          {step < QUESTIONS.length ? (
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
              
              {/* MULTIPLE CHOICE - HEIGHT ADJUSTED FOR MORE OPTIONS */}
              {currentQ.type === 'multiple' ? (
                ...
                <div className="flex gap-4 items-center">
                  <div className="flex-1 bg-slate-50 rounded-2xl p-3 border border-slate-100 focus-within:ring-2 focus-within:ring-[#0033FF] transition-all">
            ...
            <div className="text-center py-4 font-black text-[#0033FF] uppercase tracking-widest">
